...
class DataIngestion:
    ...
    def _load_env_variables(self):
        ...
        self.google_api_key = clean(os.getenv("GOOGLE_API_KEY"))
        self.db_api_endpoint = clean(os.getenv("ASTRA_DB_API_ENDPOINT"))
        self.db_application_token = clean(os.getenv("ASTRA_DB_APPLICATION_TOKEN"))
        self.db_keyspace = clean(os.getenv("ASTRA_DB_KEYSPACE"))
